package lev.philippov.geekmarket.paypal;
...
import lev.philippov.geekmarket.service.MailService;
...
public class PayPalController {
    ...
    public String buy(Model model, @PathVariable(name = "orderId") Long orderId, Principal principal) {
        try {
            ...
            transaction.setDescription("Покупка в GeekMarket");
    ...
    public String success(HttpServletRequest request, Model model, @PathVariable(name = "orderId") Long orderId) {
        try {
            ...
            if (executedPayment.getState().equals("approved")) {
                ...
                orderService.changeOrderStatus(orderId, OrderStatus.PAYD);
            } else {
